/**
 * TypeScript type definitions for the PetMeds frontend application
 * Defines interfaces for API responses, form data, and component props
 */
...
/**
 * User account information from the backend
 ...
 * Used for comprehensive household data retrieval and display
 */
export interface HouseholdWithMembers extends Household {
  members: (HouseholdMember & { user: User })[];  // All household members with user details
 ...
 * Includes dosage unit name and pet information for display
 */
 ...
 * Used for displaying medication schedules in the agenda view
 */
 ...
 * Provides common form state and handlers
 */
